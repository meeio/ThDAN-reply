...
% In this work, the probability of being a certain known class and the probability of being the unknown class can be considered independent for two reasons:
% \begin{itemize}[topsep=0pt]
%     \small
%     \item The probability of being a certain known class is independent of the probability of being a certain domain.
%     \item The proposed model uses the probability of being the target domain to approximate the probability of being the unknown class.
% \end{itemize}
...
% Instead, since samples from the unknown class are usually untransferable and are prone to be labeled as the target samples, we use the probability of being the target domain (\textit{i.e.,} the output of $G_c^{K+1}$) to approximate the probability of being the unknown class.
